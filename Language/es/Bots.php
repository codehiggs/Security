...
return [
    ...
    "create-success-message" => "El robot se registró exitosamente, para retornar al listado general de robots presioné continuar en la parte inferior de este mensaje.",
    // - Bots viewer
    ...
    "delete-success-message" => "El robot se elimino exitosamente, para retornar al listado de general de robots presioné el botón continuar en la parte inferior de este mensaje.",
    // - Bots list
