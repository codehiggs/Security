...
$journalists = $mjournalists->where('citizenshipcard', $oid)->first();

$code = "<h1>Autorizado</h1>";
$code .= "<img src=\"\" alt=\"\">";
$code .= "<b>Nombre</b>: " . @$journalists['firstname'] . "<br>";
$code .= "<b>Apellido</b>: " . @$journalists['lastname'] . "<br>";
$code .= "<b>Correo Electrónico </b>:" . @$journalists['email'] . "<br>";
