...
$m2fa = $msettings->get_Value("2fa");
$otp = $authentication->generate_Otp($email, $password);
if ($otp) {
    if ($m2fa == "true") {
        $data['otp'] = $otp;
    ...
    $c = view('App\Modules\Security\Views\Session\Signin\form', $data);
}
echo($c);
?>