    ...
    <div class="d-table-cell align-middle">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-toolbar float-right align-middle">
                    <a href="/" class="card-toolbar-btn bg-secondary border-secondary">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xl-6 col-sm-12">
                        ...
                        <ul class="modal-list">
                            <li><a href="/security/session/signup/<?php echo(lpk()); ?>">
                                    Registrese ahora!
                                </a>
                            </li>
                            <li><a href="/security/session/recovery/<?php echo(lpk()); ?>">
                    ...
                    <div class="col-xl-6 col-sm-12">
                        ...
                        <div class="m-sm-3">
                            ...
                            //-->
                            <form method="post" action="/security/session/signin/<?php echo(lpk()); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">Obligatorio.</div>
                                    <small>
                                        <a href="pages-reset-password.html">Olvido su contraseña?</a>
                                    </small>
                                </div>
                                <div>
                            ...
                            <div class="text-center mb-3">
                                No tienes una cuenta? <a href="/security/session/signup/<?php echo(lpk()); ?>">Registrate</a>
                            </div>
                        </div>
                    </div>
                </div>
