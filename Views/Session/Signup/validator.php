...
$f->set_ValidationRule("confirm", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $data['alert'] = array(
        'type' => 'danger',
        'title' => lang('Security.user-register-error'),
        'message' => lang('App.validator-errors-message'),
        'errors' => $errors
    );
    $data['voice'] = "app/validator-errors-message.mp3";
