...
$f->fields["submit"] = $f->get_Submit("submit", array("value" => lang("App.Signup"), "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
//[groups]----------------------------------------------------------------------------------------------------------------
...
$card = $b->get_Card("create", array(
    "header-back" => $back,
    "title" => lang("Security.user-register-title") . " - {$r["user"]}",
