...
* -----------------------------------------------------------------------------
*/
$f->fields["rol"] = $f->get_FieldView("rol", array("value" => $r["rol"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/security/roles/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
/*
* -----------------------------------------------------------------------------
* [Groups]
* -----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => sprintf(lang("Roles.view-title"), $oid),
    "header-back" => $back,
