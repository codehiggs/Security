...
//[Request]-----------------------------------------------------------------------------
$f->set_ValidationRule("hierarchy", "trim|required");
//$f->set_ValidationRule("user","trim|required");
$f->set_ValidationRule("rol", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $c = $bootstrap->get_Card('access-denied', array(
        ...
        'text' => lang("Security.hierarchies-create-errors-message"),
        'errors' => $errors,
        'footer-class' => 'text-center',
        'voice' => "security/hierarchies-create-errors-message.mp3",
    ));
